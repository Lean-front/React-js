    ...
    useEffect(() => {
        setTimeout(() => {
            ...
            let ListProducts = [
                ...
                { id: "08", name: "Celular Xiaomi 9A", stock: 20, initial: 0, precio: "28000", categoria: "celulares", img: "https://http2.mlstatic.com/D_NQ_NP_981867-MLA48770610134_012022-O.webp" },
                { id: "09", name: "Tablet Philco TP7A6", stock: 50, initial: 0, precio: "11000", categoria: "tablets", img: "https://http2.mlstatic.com/D_NQ_NP_845915-MLA47848867480_102021-O.webp" },
                { id: "10", name: "Notebook Dell Inspiron 3505", stock: 60, initial: 0, precio: "135000", categoria: "notebooks", img: "https://http2.mlstatic.com/D_NQ_NP_790874-MLA44939295335_022021-O.webp" },
            ]
...
const onAdd = (amount) =>{
    ...
    return (
        <>
            <ItemDetail productId={productId} onAdd={onAdd} added={added}/>
        </>
    );
*/